...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('programme_code', models.CharField(help_text='2-digit Numeric Code allotted to the programme', max_length=2, verbose_name='Programme Code')),
                ('full_programme_code', models.CharField(editable=False, help_text='4-digit Numeric Code uniquely identifying a programme', max_length=4, verbose_name='Full Programme Code')),
                ('programme_name', models.CharField(max_length=255, verbose_name='Programme Name')),
                ('programme_id', models.CharField(max_length=255, unique=True, verbose_name='Programme ID')),
