    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_year', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='choice.academic_year')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referee_name', models.CharField(max_length=255, verbose_name='Referee Name')),
                ('referee_email', models.EmailField(max_length=254, verbose_name='Referee Email')),
                ('referee_designation', models.CharField(max_length=255, verbose_name='Referee Designation')),
                ('referee_organization', models.CharField(max_length=255, verbose_name='Referee Organization')),
                ('referee_number', models.BigIntegerField(verbose_name='Referee Contact Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('overall_intellectual_ability', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Overall Intellectual Ability')),
                ('analytical_ability', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Analytical Ability')),
                ('goal_clarity', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Clarity of Goal')),
                ('overall_potential', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Overall Potential')),
                ('oral_expression_english', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Oral Expression in English')),
                ('written_expression_english', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='written Expression in English')),
                ('work_independently', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Ability to Work Independently')),
                ('work_with_others', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Ability to Work with Others')),
                ('research_potential', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Research Potential')),
                ('motivation', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Below 50%', 'Below 50%'), ('Top 50%', 'Top 50%'), ('Top 20%', 'Top 20%'), ('Top 10%', 'Top 10%'), ('Top 5%', 'Top 5%'), ('Top 1%', 'Top 1%')], default='Uncertain', max_length=255, verbose_name='Motivation')),
                ('recommendation', models.CharField(choices=[('Uncertain', 'Uncertain'), ('Not Recommended', 'Not Recommended'), ('Unenthusiastically', 'Unenthusiastically'), ('Fairly Strongly', 'Fairly Strongly'), ('Strongly', 'Strongly'), ('Enthusiastically, without reservation', 'Enthusiastically, without reservation')], default='Uncertain', max_length=255, verbose_name='You Recommend this applicant')),
                ('recommendation_id', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, to='admission.recommendation')),
            ],
            options={
