    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter_of_recommendation', models.FileField(upload_to=admission.models.advertisement.upload_recommendation, verbose_name='Letter of Recommendation Template')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Recommendation',
            fields=[
                ('referral_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Referral ID')),
                ('referree_email', models.EmailField(max_length=254, verbose_name='Referree Email')),
                ('letter_of_recommendation', models.FileField(blank=True, null=True, upload_to=admission.models.recommendation.upload_recommendation, verbose_name='Letter of Recommendation')),
