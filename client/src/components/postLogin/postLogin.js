...
class PostLogin extends Component {
  ...
  componentDidMount() {
    this.props.location.pathname === this.props.match.url + '/home'
      ? this.setState({
        activeNavItem: 0,
        activeItemType: "home"
      }) : this.props.location.pathname === this.props.match.url + '/change-password'
        ? this.setState({
          activeNavItem: 2,
          ...
          }) : this.props.location.pathname === this.props.match.url + '/personal-details'
            ? this.setState({
              activeNavItem: 4,
              activeItemType: 'personal-details'
            }) : this.props.location.pathname === this.props.match.url + '/educational-details'
              ? this.setState({
                activeNavItem: 5,
                activeItemType: 'educational-details'
              }) : this.props.location.pathname === this.props.match.url + '/employment-details'
                ? this.setState({
                  activeNavItem: 1,
  ...
  render() {
    ...
    switch (this.state.activeNavItem) {
      case 0: renderdata = <div> this is post login </div>
        break;
      case 1: renderdata = <div> this is employment details page</div>
        break;
      case 2: renderdata = <div> this is change password </div>
        break;
      case 3: renderdata = <div> this is applications</div>
        break;
      case 4: renderdata = <PersonalDetails />
        break;
      case 5: renderdata = <EducationalDetails />
        break;
      default: renderdata = <div> this is post login </div>
        break;
    }

    return <div>
      <LoginNav onNavigationItemClick={this.onNavigationItemClick} activeItem={this.state.activeNavItem} />
      <div>
        {renderdata}
      </div>
