                        ...
                        <td>
                          <Form.Group className={classes.ExaminationName}>
                            <Form.Control
                              ...
                              onChange={(e) =>
                                this.onChange(e.target.value, index, "examinationName")
                              }
                              type="text"
                              required
                            />
                            <span className={classes.ErrorMessage}>{!item.examinationNameValidity ? "* Please enter a valid title." : null}</span>
                          </Form.Group>
                        </td>
                        <td>
                          <Form.Group className={classes.Year}>
                            <Form.Control
                              ...
                              onChange={(e) =>
                                this.onChange(e.target.value, index, "yearOfApperance")
                              }
                              type="number"
                              required
                            />
                        ...
                        <td>
                          <Form.Group className={classes.RegNumber}>
                            <Form.Control
                              ...
                              onChange={(e) =>
                                this.onChange(e.target.value, index, "regNumber")
                              }
                              type="text"
                              required
                            />
                            <span className={classes.ErrorMessage}>{!item.regNumberValidity ? "* Please enter a valid title." : null}</span>
                          </Form.Group>
                        </td>
                        <td>
